...
const PostReportsModal = ({ post, onClose, onDeleteReport }) => {
  const styles = {
    overlay: {
  ...
  return (
    <div style={styles.overlay} onClick={onClose}>
      <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
        <h2 style={styles.header}>Reports for: {post.title}</h2>
        ...
        {post.reports && post.reports.length > 0 ? (
            ...
            {post.reports.map((report: any, idx: number) => (
              <li key={idx} style={styles.reportItem}>
                ...
                <button
                  ...
                  onClick={() =>
                            openConfirmation("Are you sure you want to delete this report?", () => onDeleteReport(report._id, post._id))
                          }   
                >
                  Delete
                </button>
          ...
          <p style={styles.emptyText}>No reports for this post.</p>
        )}
