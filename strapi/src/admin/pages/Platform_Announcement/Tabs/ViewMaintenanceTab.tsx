...
const ViewMaintenanceTab: React.FC = () => {
  const [features, setFeatures] = useState<MaintenanceAlert[]>([]);
    ...
    <div style={strapiStyles.container}>
      <div style={strapiStyles.contentBox}>
        ...
        <div style={strapiStyles.header}>
          <h2 style={strapiStyles.title}>Maintenance Alerts</h2>
        </div>
        ...
        <div style={strapiStyles.searchSection}>
          <input
            type="text"
            placeholder="Search alert by message"
            value={search}
            onChange={(e) => {
        ...
        <div style={strapiStyles.tableContainer}>
          {loading ? (
            <p style={strapiStyles.loadingText}>Loading alerts...</p>
          ) : (
      ...
      <ConfirmationModal
        message="Are you sure you want to delete this maintenance alert?"
